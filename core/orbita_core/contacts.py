...
Трасса суток хранится не как 720 снимков, а как список возможных рёбер и битовая
матрица «отсчёты × рёбра» (ADR-002, ADR-010): для 48 аппаратов это единицы сотен
килобайт вместо сотен мегабайт JSON.
"""
