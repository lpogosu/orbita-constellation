...
Снимки воспроизводимы: `python scripts/capture_screens.py` на поднятом `make up` заводит
проект, три расчёта, вариант с отказами и перебор через API и снимает экраны — числа на
них настоящие, а не из мокапа.
