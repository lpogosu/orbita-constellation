...
const READ_ONLY_MESSAGE = 'Демо только для просмотра: изменения не сохраняются. Полный стек — make up, см. README.';
const NOT_RECORDED_MESSAGE = 'Этого ответа нет в записи демо. Свои расчёты — в полном стеке: make up.';
