  ...
  const heading = (
    <>
      ...
      {/* На полотне подпись делит строку с заголовком: подросший на ноутбуке кегль
          ...
          заголовка, а не собственной длиной. Видна короткая форма: «наблюдаемая» — то слово,
          ради которого подпись есть; полная формулировка в подсказке. */}
      <p
        className={cx(
          'text-caption text-ink-muted',
          !stacked && 'absolute right-[23px] top-[19px] max-w-[360px] whitespace-nowrap',
        )}
